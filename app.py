...
win=Tk()
win.title('EMPOLYEE MANGEMENT SYSYTEM')
win.config(bg='gray')
...
def salary():
      root=Tk()
      root.title('SALARY MANGEMENT')
      root.config(bg='gray')
      root.geometry('800x600')

      l8=Label(root,text='SALARY MANGEMENT',width=35,bg='white',
      ...
      l10=Label(root,text='SEE SALARY HERE !!!!',bg='white',fg='black',height=5,width=30,bd=5,
